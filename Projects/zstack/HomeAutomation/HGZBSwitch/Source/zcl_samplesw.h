...
// UI Events 已移除: SAMPLEAPP_LCD_AUTO_UPDATE_EVT (0x0010) 和 SAMPLEAPP_KEY_AUTO_REPEAT_EVT (0x0020) 不再使用
...
// v1.0.8变更: 移除SAMPLESW_LED_PWM_EVT和SAMPLESW_LED_PWM_PERIOD_MS定义
// 原因: PWM定时器(5ms周期)持续运行占用MCU资源, 影响Zigbee协议栈时序, 导致信号不稳定
// LED亮度恢复为100% (直接写GPIO), 优先保证RF通信稳定性
